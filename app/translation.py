class SimpleTranslator:
    def __init__(self, translation_file=None):
        self.dictionary = {
            ...
            "yunggurr-wirrika": "very thirsty / cannot drink",
            "gulan-wuku": "bleeding",
            ...
            "dhukarr-buku": "feeling anxious / scared",
            ...
            "djama-wuku": "need help urgently",
            "dhipinu-wirrika": "feeling better",
            "marrtjin": "not feeling well",
            "wayin": "sick / unwell",
            "ga": "and", "rua": "two", "wanggany": "one",
